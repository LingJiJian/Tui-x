...
TH = function(){
	...
	this.parseContent = function(){
		...
		var path = "PATH_"+sceneName.toUpperCase()+" = "+"\""+this.flaPath +"\""+ "\r\n\r\n";
		var middle = path+"";
...
/** 转换Circlemenu */
FlaToXML.prototype.convertCirclemenu = function(menu,elementIndex,frameName){
	var xml_menu = new UICircleMenu();
	this.fullNormalAttirbute( xml_menu,this.th, menu ,elementIndex ,frameName);
...
tui.th.flaPath = "res/tui/tui_"+sceneName+".xml";//xml命名为fla
var saveXmlPath = "file:///F|/WorkSpace/C++WorkSpace/cocos2d-x-3.0/projects/HelloTuiLua/"+tui.th.flaPath;//保存xml的路径
var saveHPath = "file:///F|/WorkSpace/C++WorkSpace/cocos2d-x-3.0/projects/HelloTuiLua/src/tagMap/Tag_"+sceneName+".lua";//保存lua的路径
