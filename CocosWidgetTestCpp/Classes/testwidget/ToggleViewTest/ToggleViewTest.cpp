...
bool CToggleViewBasicTest::init()
{
	...
	pToggle->setPosition(Point(480, 320));
...
bool CToggleViewGroupTest::init()
{
	...
	pToggle1->setPosition(Point(200, 450));
	...
	pToggle2->setPosition(Point(200, 350));
	...
	pToggle3->setPosition(Point(200, 250));
	...
	pText1->setPosition(Point(350, 450));
	...
	pText2->setPosition(Point(350, 350));
	...
	pText3->setPosition(Point(350, 250));
