...
void CCheckBoxTestSceneBase::onNextBtnClick(Ref* pSender)
{
	nextCCheckBoxTestScene();
}

void CCheckBoxTestSceneBase::onBackBtnClick(Ref* pSender)
{
	backCCheckBoxTestScene();
}

void CCheckBoxTestSceneBase::onRefBtnClick(Ref* pSender)
{
...
void CCheckBoxBasicTest::onClick(Ref* pSender)
{
...
void CCheckBoxExclusionTest::onClick(Ref* pSender)
{
