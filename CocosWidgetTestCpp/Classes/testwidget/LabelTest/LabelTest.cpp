...
bool CLabelBasicTest::init()
{
	...
	pText1->enableShadow();
	pText1->setPosition(Vec2(480, 450));
	...
	pText6->setPosition(Vec2(480,270));
	...
	pText7->setPosition(Vec2(300,220));
	...
	pText8->setPosition(Vec2(400,220));
	...
	pText9->setPosition(Vec2(500,220));
