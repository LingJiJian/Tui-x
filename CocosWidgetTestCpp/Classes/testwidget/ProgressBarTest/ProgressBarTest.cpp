...
void CProgressBarTestSceneBase::onNextBtnClick(Ref* pSender)
{
	nextCProgressBarTestScene();
}

void CProgressBarTestSceneBase::onBackBtnClick(Ref* pSender)
{
	backCProgressBarTestScene();
}

void CProgressBarTestSceneBase::onRefBtnClick(Ref* pSender)
{
...
void CProgressBarBasicTest::onProgressing(Ref* pSender, int nValue)
{
	char buff[82] = {0};
