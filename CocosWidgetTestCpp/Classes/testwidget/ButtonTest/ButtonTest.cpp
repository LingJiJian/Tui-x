...
bool CButtonBasicTest::init()
{
	...
	pButton->setPosition(Point(480, 320));
	...
	pArmBtn->setPosition(Point(100, 270));
	...
	pStep->setPosition(Point(650,320));
...
bool CButtonEventTest::init()
{
	...
	pButton2->setPosition(Point(610, 320));
	m_pWindow->addChild(pButton2);

	m_pText2 = CLabel::create();
	m_pText2->setAnchorPoint(Point(0, 0.5));
	m_pText2->setPosition(Point(520, 430));
...
{
	Point tPoint = m_pWindow->convertTouchToNodeSpace(pTouch);
...
bool CButtonWithTextTest::init()
{
	...
	pText1->setPosition(Point(260, 430));
	...
	pButton2->setLabelOffset(Point(0, 10));
	pButton2->setPosition(Point(610, 320));
	m_pWindow->addChild(pButton2);

	CLabel* pText2 = CLabel::create();
	pText2->setAnchorPoint(Point(0, 0.5));
	pText2->setPosition(Point(520, 430));
...
bool CButtonAttributeTest::init()
{
	...
	pButton1->setPosition(Point(480, 500));
	...
	pButton1ex->setPosition(Point(680, 500));
	pButton1ex->setEnabled(false);
	m_pWindow->addChild(pButton1ex);

	CLabel* pText1 = CLabel::create();
	pText1->setAnchorPoint(Point(1, 0.5));
	pText1->setPosition(Point(350, 500));
	...
	pButton2->setPosition(Point(480, 400));
	...
	pButton2ex->setPosition(Point(680, 400));
	pButton2ex->setTouchEnabled(false);
	m_pWindow->addChild(pButton2ex);

	CLabel* pText2 = CLabel::create();
	pText2->setAnchorPoint(Point(1, 0.5));
	pText2->setPosition(Point(350, 400));
	...
	pButton3->setPosition(Point(480, 300));
	...
	pButton3ex->setPosition(Point(680, 300));
	pButton3ex->setVisible(false);
	m_pWindow->addChild(pButton3ex);

	CLabel* pText3 = CLabel::create();
	pText3->setAnchorPoint(Point(1, 0.5));
	pText3->setPosition(Point(350, 300));
...
bool CButton9SpriteTest::init()
{
	...
	pButton->setPosition(Point(480, 370));
	m_pWindow->addChild(pButton);
	...
	pButton2->setPosition(Point(480, 270));
	m_pWindow->addChild(pButton2);
