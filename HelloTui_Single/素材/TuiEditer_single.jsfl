...
if(label.filters != undefined){
	...
	var fontFile = label.textRuns[0].textAttrs.face.replace("-","/").replace("*","");
...
var saveXmlPath = "file:///F|/WorkSpace/C++WorkSpace/cocos2d-x-3.0/projects/HelloTui/Resources/tui/480x800.xml";//保存xml的路径
var saveHPath = "file:///F|/WorkSpace/C++WorkSpace/cocos2d-x-3.0/projects/HelloTui/Classes/tui/tuiTagMap.h";//保存h的路径
